...
def run_Nash_Agent(MAX_EPISOIDE=1500, MAX_TIME_STEP=15,batch_update_size=100, buffersize=5000, AN_file_name="Action_Net",
    ...
    np.savetxt(r'X:\data\study\Reward\0.0009-999.reward' + str(user_num) + '.txt',
               reward_list[MAX_EPISOIDE - 1])
    np.savetxt(r'X:\data\study\Energy\0.0009-999.energy' + str(user_num) + '.txt', energy)
    np.savetxt(r'X:\data\study\Latency\0.0009-999.latency' + str(user_num) + '.txt', latency)
    ...
    plt.xlabel('Episode')
    plt.ylabel('Reward')
    plt.savefig(r'X:\data\study\Reward\0.0009-999_reward.png')
    plt.close()
    ...
    plt.xlabel('Episode')
    plt.ylabel('Energy')
    plt.savefig(r'X:\data\study\Energy\0.0009-999_energy.png')
    plt.close()
    ...
    plt.xlabel('Episode')
    plt.ylabel('Latency')
    plt.savefig(r'X:\data\study\Latency\0.0009-999_latency.png')
    plt.close()
